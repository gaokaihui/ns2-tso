...
#define PKT_SIZE 500 // B
#define MB_DU 300 // microburst duration
#define REAL_CAPACITY 1 // Mbps
#define REAL_BUFFER_SIZE 0.2 //MB
...
const double INIT_TIMER1 = 1000 * (1 + ALPHA * SWITCH_PORTS) / ((1 + ALPHA * SWITCH_PORTS / 2.0) * (1 + ALPHA * SWITCH_PORTS / 2.0));
